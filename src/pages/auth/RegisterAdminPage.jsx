...
const RegisterAdminPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.identificador_admin.trim().length < 4) {
      return;
    }
              ...
              <form onSubmit={handleSubmit} className="row g-3">
                <div className="col-12">
                  ...
                  <input
                    ...
                    className={`form-control ${formData.identificador_admin.length > 0 && formData.identificador_admin.trim().length < 4 ? 'is-invalid' : ''}`}
                    onChange={handleChange}
                    required
                    maxLength={4}
                  />
                  <div className="invalid-feedback">
                    El Número de control / ID debe tener al menos 4 caracteres
                  </div>
                </div>
                <div className="col-12">
                  <label>Nombre</label>
