...
const ResultadosSemestreAdmin = () => {
  ...
  // Cargar resultados cuando cambie el periodo
  useEffect(() => {
    ...
    const fetchResultados = async () => {
      ...
      try {
        const res = await administrativosService.getResultadosSemestre(selectedPeriodo);
        if (res.success) {
        ...
        console.error("Error cargando resultados por semestre:", error);
        setResultados([]);
      } finally {
        ...
        <div className="card shadow-lg border-0 rounded-3 overflow-hidden">
          ...
          <div className="card-header bg-white border-bottom p-4 d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
            <div className="d-flex align-items-center">
              ...
              <div className="ms-3">
                <h4 className="mb-0 fw-bold text-tec">Resultados por semestre</h4>
                <small className="text-muted">Resultados de todas las carreras en un periodo</small>
              </div>
            </div>
...
export default ResultadosSemestreAdmin;
